import { OAUTH_BASE } from "../api/client";
import { useAuthConfig } from "../api/hooks";

/** "Continue with Google" — only rendered when the backend has OAuth configured. */
export default function GoogleButton() {
  ...
  return (
    <>
      ...
      <button type="button" onClick={go} className="btn-glass w-full">
